<?php
	...
	require_once(TEMPLATEPATH . '/functions/menus.php'); // Front End Menus
	require_once(TEMPLATEPATH . '/functions/posts.php'); // Post Settings
	...
	require_once(TEMPLATEPATH . '/functions/cpt.php'); // Custom Post Types
	require_once(TEMPLATEPATH . '/functions/users.php'); // Special user permissions for Company ordering
